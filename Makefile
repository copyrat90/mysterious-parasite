...
LIBBUTANO   :=  ../butano
PYTHON      :=  python
SOURCES     :=  src src/scene src/cmd src/game src/game/mob src/game/mob/ai src/game/item src/game/item/ability src/game/state src/game/obj src/debug iso_bn/src
